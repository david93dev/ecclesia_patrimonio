...
export const SidebarMenu = ({ items, collapsed, activeItem, onSelect }) => (
  <nav aria-label="Navegação principal" className="flex-1 space-y-1 overflow-y-auto px-3 py-5">
    <p className={`mb-3 overflow-hidden px-3 text-[9px] font-bold tracking-[.18em] text-[#68617f] uppercase transition-all ${collapsed ? "h-0 opacity-0" : "h-auto opacity-100"}`}>Navegação</p>
